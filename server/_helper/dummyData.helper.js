const jobCVService = require("../models/jobCV");
const JobPostService = require("../models/JobPosts");
            ...
            for (let i = 0; i < 1000; i++) {
                ...
                for (const iterator of new Array(n)) {
                    ...
                    try {
                        ...
                        if(1000 === i+1){
                            await JobPostService.insertMany(jobs);
                            return {}
                        }
            ...
            for (let i = 0; i < 1000; i++) {
                ...
                for (const iterator of new Array(n)) {
                    ...
                    try {
                        jobs.push(cv)
                        if(1000 === i+1){
                            await jobCVService.insertMany(jobs)
                            return {}
                        }
